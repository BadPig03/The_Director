...
public static class Globals
{
    ...
    public static readonly List<KeyValue> emptyKeyValueList = new() {new KeyValue { Key = "EMPTY", Value = "true" } };
    ...
    public static readonly string L4D2VPKPath = L4D2RootPath + "\\bin\\vpk.exe";
